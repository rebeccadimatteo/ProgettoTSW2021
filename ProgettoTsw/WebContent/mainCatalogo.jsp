...
<% Catalogo prodotti=(Catalogo)request.getAttribute("Catalogo"); 
		for(int i=0;i<prodotti.lengthCatalogo();i++){
			...
			<p align="center"><b><%= el.getNome()  %></b> </p>
			<p align="center"><img src="<%= el.getImg() %>" width="400" height="400"></p>
			<p align="center"> Codice prodotto: <%= el.getCodice()  %> <br> Prezzo: $ <%= el.getPrezzo()%><br></p><br>
