...
<body>
	...
	left: 2%;">
					...
					<button onclick="location.href='mainCatalogo.jsp'" style="font-size:24px; width:50%;display:contents; float:left;" id="pulsante">Ritorna al Catalogo<i class="fa fa-arrow-circle-left" style="color: #800000"></i></button>
