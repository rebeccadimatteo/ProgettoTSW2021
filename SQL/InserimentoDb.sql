...
racchiusa in una sacca di pasta filata.",9,1.00,"F","images/burrata.jpg",1);
...
insert into Prodotto(Codice,Nome,Descrizione,Prezzo,Peso,CodiceCategoria,image,quantita) values ("009","Cavatelli","Noti come capuniti, si ottengono strisciando un rotolino di impasto di farina e acqua con tre dita in modo da formare un incavo","3.00","0.500","P"," images/cavat.jpg ",1);
...
leggermente fruttate.", "11", "75", "VL"," images/falang.jpg ",1);
